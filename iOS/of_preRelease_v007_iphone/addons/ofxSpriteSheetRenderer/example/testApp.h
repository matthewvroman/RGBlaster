...
//create a new animation. This could be done optinally in your code andnot as a static, just by saying animation_t defaultAnimation; defaultAnimation.index =0, defaultAnimation.frame=0 etc. I find this method the easiest though
