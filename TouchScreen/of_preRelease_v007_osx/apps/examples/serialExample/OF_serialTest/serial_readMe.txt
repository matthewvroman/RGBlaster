...
c) open the serial monitor and type the letter a.  It something takes 5-15 seconds for serial i/o to respond.  You should see an LED blink and the letters ABC in the console.
